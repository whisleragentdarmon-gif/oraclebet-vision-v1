    ...
    <div className="mt-6 space-y-6 font-sans text-white">
      ...
      <div className="bg-neutral-900 border border-neutral-800 rounded-xl p-5">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 text-center mb-4">
              ...
              <div>
                  <div className="text-[10px] text-gray-500 uppercase mb-2">Advantage</div>
                  <input 
                    value={report.h2h?.advantage || 'P1'} 
              ...
              <div>
                  ...
                  <input 
                    value={report.h2h?.trend || 'P1 gagne 4/4'} 
