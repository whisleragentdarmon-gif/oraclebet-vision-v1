export const DEMO_MATCHES = [
    ...
    {
        id: "demo_sinner_alcaraz",
        identity: {
            p1Name: "Jannik Sinner", p2Name: "Carlos Alcaraz",
            tournament: "ATP Indian Wells", surface: "Dur", date: "10.03.2025", time: "20:00"
        },
        p1: {
    ...
    {
        id: "demo_nadal_djokovic",
        identity: {
            p1Name: "Rafael Nadal", p2Name: "Novak Djokovic",
            tournament: "Roland Garros", surface: "Terre Battue", date: "05.06.2025", time: "15:00"
        },
        p1: {
            rank: "15", bestRank: "1", nationality: "ESP", ageHeight: "38 / 1.85m", hand: "Gaucher",
            holdPercent: "82%", breakPercent: "35%", form: "7/10", injury: "Genou (Doute)",
            wl2024: "10-5", oddsPlayer: "2.50"
        },
        p2: {
            rank: "1", bestRank: "1", nationality: "SRB", ageHeight: "37 / 1.88m", hand: "Droitier",
            holdPercent: "90%", breakPercent: "30%", form: "9/10", injury: "Aucune",
    ...
    {
        id: "demo_swiatek_sabalenka",
        identity: {
            p1Name: "Iga Swiatek", p2Name: "Aryna Sabalenka",
            tournament: "WTA Madrid", surface: "Terre Battue", date: "02.05.2025", time: "18:00"
        },
        p1: {
    ...
    {
        id: "demo_medvedev_kyrgios",
        identity: {
            p1Name: "Daniil Medvedev", p2Name: "Nick Kyrgios",
            tournament: "Wimbledon", surface: "Herbe", date: "05.07.2025", time: "14:00"
        },
        p1: {
    ...
    {
        id: "demo_ruud_schwartzman",
        identity: {
            p1Name: "Casper Ruud", p2Name: "D. Schwartzman",
            tournament: "ATP Monte Carlo", surface: "Terre Battue", date: "15.04.2025", time: "11:00"
        },
        p1: {
    ...
    {
        id: "demo_bublik_monfils",
        identity: {
            p1Name: "Alexander Bublik", p2Name: "Gael Monfils",
            tournament: "ATP Montpellier", surface: "Indoor", date: "06.02.2025", time: "19:00"
        },
        p1: {
